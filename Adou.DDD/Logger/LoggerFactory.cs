using System;
using Adou.DDD.Logger.Implements;
using System.Configuration;

namespace Adou.DDD.Logger
{
    public sealed class LoggerFactory: ILogger
    {
        ...
        {
            string type = "file";
            if (!string.IsNullOrEmpty(ConfigurationManager.AppSettings["LoggerType"]))
            {
                type = ConfigurationManager.AppSettings["LoggerType"].ToLower();
            } 
        ...
        /// 日志级别
        /// </summary>
        private static Level level = (Level)Enum.Parse(typeof(Level), ConfigurationManager.AppSettings["LoggerLevel"].ToUpper());
        /// <summary>
        /// 线程锁
        /// </summary>
