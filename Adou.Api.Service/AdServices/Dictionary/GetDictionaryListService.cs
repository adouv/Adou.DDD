...
namespace Adou.Api.Service.AdServices.Dictionary
{
    ...
    /// 获取字典列表服务
    /// </summary>
    public class GetDictionaryListService : ApiBase<RequestGetDictionaryListModel>
    {
        ...
        protected override void ExecuteMethod()
        {
            ...
            var result = dictionaryRep.GetDictionaryList(this.Parameter.OrderBy, this.Parameter.IsDesc, model);
